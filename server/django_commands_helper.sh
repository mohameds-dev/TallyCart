...
commands=(
  ...
  "python manage.py load_products_data           # load products data from CSV"
...
elif [[ "$cmd" == "python manage.py load_products_data" ]]; then
  read -p "Enter path to CSV file (e.g. ../data/receipts_data.csv): " csv_path
  python manage.py load_products_data "$csv_path"
